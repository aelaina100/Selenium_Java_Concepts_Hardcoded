...
public class  Added10_assertions {
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	 ...
	 * 
		...
		Assert.assertTrue(driver.switchTo().alert().getText().contains(".."));
		
		Assert.assertNotEquals(driver.switchTo().alert().getText(), null); // Ensures that there is test in the al
	 * 
	 * 
	 * 
	 * 
