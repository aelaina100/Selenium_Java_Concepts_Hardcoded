...
// Now- from the 1st dropdown only- Select ANY city ==> in-console validate: //a[@value='MAA']   So, what would the outcome be ?(try it)?
	...
	// you can do it. But here, I choose : (//a[@value='MAA'])[1] since the 2nd index has to be used (still not a good reason. There is 0 diff. But still 100 percent correct)
