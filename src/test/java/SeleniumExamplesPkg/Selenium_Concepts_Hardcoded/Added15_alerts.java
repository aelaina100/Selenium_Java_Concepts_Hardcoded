...
public class Added15_alerts {
	...
	public void alertVerifyTest()
	{
		...
		Assert.assertNotEquals(driver.switchTo().alert().getText(), null); // ensures the pop up has text inside of it.
		                                                                   // double check the 'null' 2nd argument.
		// Very above line can also be achieved with the .getText().length()>0  try it.
