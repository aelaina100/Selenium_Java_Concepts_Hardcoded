...
public class Added13_Crucial_Assignment {
	...
	public void Added13_AssignmentTest() throws InterruptedException
	{
		  ...
		  // Verifying the message "Success! The Form has been submitted successfully!." is not dispayed onto the screen as it can only be after submitting the form.
		  //System.out.println("===> " +driver.findElement(By.cssSelector(".alert.alert-success.alert-dismissible")).getText());
		   System.out.println("AAA: "+ driver.findElement(By.cssSelector("div.alert")).isDisplayed());
