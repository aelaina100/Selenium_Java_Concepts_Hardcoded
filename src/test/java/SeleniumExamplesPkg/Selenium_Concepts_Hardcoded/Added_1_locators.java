...
//is not clickable at point (274, 354). Other element would receive the click: 
   ...
   // Second TestCase (IMPORTANT):
	...
	public void C_SalesForceTest()
	{
		...
		// But keep in mind that it's too long===> you can have:    input.input                   (As long as it UNIQUELY identifies the correct intended element)  OR
		                                                                input.input.r4            (As long as it UNIQUELY identifies the correct intended element)
		                                                                input.input.r4.wide                   // // // // // // // // // // // // // // // // // //
		                                                                input.input.r4.wide.mb16              // // // // // // // // // // // // // // // // // //
		                                                                input.input.r4.wide.mb16.mt8          // // // // // // // // // // // // // // // // // //
		                                                                input.input.r4.wide.mb16.mt8.username // // // // // // // // // // // // // // // // // //
		
		Or simply use ClassName locator where, in here, 6 seperate values are given ( and seperated by spaces)
		*/
		
		// or even the below line:
		//driver.findElement(By.xpath("//input[@class= 'input r4 wide mb16 mt8 username']")).sendKeys("USERNAMMMMAEE");
		 // In the above xpath, the full value MUST  be given ''input r4 wide mb16 mt8 username'..100 !
